...
listener::listener(std::string_view host, std::string_view port, network net, addr_protocol proto, std::chrono::microseconds timeout)
    : fd{invalid_fd}
{
...
bool listener::listen(size_t max_pending) const noexcept
{
