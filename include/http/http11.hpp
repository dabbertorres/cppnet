...
std::error_condition read_headers(io::buffered_reader<char>& reader,
                                  request&                   req,
...
request_decode(io::buffered_reader<char>& reader,
               size_t                     max_header_bytes = std::numeric_limits<size_t>::max()) noexcept;

result<client_response, std::error_condition>
response_decode(io::buffered_reader<char>& reader,
                size_t                     max_header_bytes = std::numeric_limits<size_t>::max()) noexcept;
